...
from src.pytorch_faster_rcnn_tutorial.metrics.bounding_box import BoundingBox
from src.pytorch_faster_rcnn_tutorial.metrics.enumerators import BBFormat, BBType
...
def get_filenames_of_path(path: pathlib.Path, ext: str = "*") -> List[pathlib.Path]:
    ...
    """
    filenames = [file for file in path.glob(ext)]
